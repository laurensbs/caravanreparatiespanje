            ...
            {showCreate ? (
              ...
              <>
                ...
                <button
                  type="button"
                  onClick={() => setShowCreate(true)}
                  className="flex w-full items-center gap-2 px-3 py-2 text-xs text-foreground hover:bg-muted/40 dark:hover:bg-accent transition-colors text-left border-t border-border/60 dark:border-border"
                >
