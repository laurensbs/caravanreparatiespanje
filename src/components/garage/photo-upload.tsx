...
function PhotoSourceSheet({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-sm rounded-t-3xl bg-stone-900 ring-1 ring-white/10 shadow-2xl pb-[max(1rem,env(safe-area-inset-bottom))] sm:rounded-2xl motion-safe:animate-slide-up"
