-- Part Categories table (DB-driven, replaces hardcoded PART_CATEGORIES)
...
-- Seed default categories (English translations of existing Dutch categories)
INSERT INTO "part_categories" ("key", "label", "icon", "color", "sort_order") VALUES
...
-- Migrate existing parts from Dutch to English category keys
UPDATE "parts" SET "category" = 'electrical' WHERE "category" = 'elektra';
UPDATE "parts" SET "category" = 'windows' WHERE "category" = 'ramen';
UPDATE "parts" SET "category" = 'bodywork' WHERE "category" = 'carrosserie';
UPDATE "parts" SET "category" = 'plumbing' WHERE "category" = 'sanitair';
UPDATE "parts" SET "category" = 'climate' WHERE "category" = 'klimaat';
UPDATE "parts" SET "category" = 'storage' WHERE "category" = 'stalling';
UPDATE "parts" SET "category" = 'cleaning' WHERE "category" = 'reiniging';
UPDATE "parts" SET "category" = 'services' WHERE "category" = 'diensten';
UPDATE "parts" SET "category" = 'materials' WHERE "category" = 'materiaal';
UPDATE "parts" SET "category" = 'interior' WHERE "category" = 'interieur';
-- 'chassis' and 'transport' stay the same
